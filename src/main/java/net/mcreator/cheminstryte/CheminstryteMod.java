 ...
 *
 */
package net.mcreator.cheminstryte;
...
@Mod("cheminstryte")
public class CheminstryteMod {
	public static final Logger LOGGER = LogManager.getLogger(CheminstryteMod.class);
	public static final String MODID = "cheminstryte";
